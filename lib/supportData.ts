    ...
    categories: [
      {
        ...
        faqs: [
          ...
          { q: "Milliseid dokumente on vaja?", a: "Kehtiv juhiluba, sõiduki registreerimistunnistus, isikut tõendav dokument ning muud Eesti seadusest tulenevad kaubaveonõuded." },
      ...
      {
        slug: "senders",
        icon: Package, title: "Klientidele", desc: "Veotellimused, jälgimine kaardil ja arved.",
        faqs: [
          ...
          { q: "Mis siis, kui mu kaup on kahjustatud?", a: "Võta kohe ühendust meie tugimeeskonnaga (info@heva.me). Vaatame iga juhtumi läbi eraldi ja leiame lahenduse." },
        ],
      },
      {
        slug: "app",
      ...
      },
      {
        ...
        faqs: [
          ...
          { q: "Kuidas Heva turvalisust tagab?", a: "Kontrollitud juhid (iga kuller kontrollitakse enne aktiveerimist), reaalajas jälgimine, kohaletoimetamise tõend (foto, allkiri, märkused) ja hindamissüsteem pidevaks kvaliteedi jälgimiseks." },
    ...
    categories: [
      {
        ...
        faqs: [
          ...
          { q: "What documents are required?", a: "Valid driving licence, vehicle registration certificate, identity document and other commercial freight transport requirements under Estonian law." },
      ...
      },
      {
        ...
        faqs: [
          ...
          { q: "What if my cargo is damaged?", a: "Contact our support team immediately (info@heva.me). We review each case individually and find a resolution." },
        ],
      },
      {
        slug: "app",
      ...
      },
      {
        ...
        faqs: [
          ...
          { q: "How does Heva ensure safety?", a: "Verified drivers (every courier is checked before activation), real-time tracking, proof of delivery (photo, signature, notes) and a rating system for continuous quality monitoring." },
