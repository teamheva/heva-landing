...
import {
  ...
  UserCheck, HelpCircle, ArrowRight, Mail, Phone, ChevronDown,
} from "lucide-react";
...
export default function SupportPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <div className="pt-32 pb-14 sm:pt-40 sm:pb-16 bg-[#f7f8fc]">
        <div className="max-w-2xl mx-auto px-5 sm:px-8 text-center">
          ...
          >
            ...
            <input
              ...
              className="w-full pl-11 pr-5 py-4 rounded-2xl text-[15px] text-[#0f1117] placeholder-[#9ca3af] bg-white border border-[#e5e7eb] outline-none focus:border-[#025bff] transition-colors duration-150"
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8">
        ...
        <section className="py-12 sm:py-14">
          <p className="text-[11px] font-bold text-[#9ca3af] tracking-[0.14em] mb-6">{c.categoriesLabel}</p>
            ...
            {c.categories.map((cat, i) => {
              ...
              return (
                <motion.a
                  ...
                  className="group flex items-start gap-4 p-5 bg-white rounded-2xl border border-[#e5e7eb] hover:border-[#025bff]/40 hover:bg-[#fafbff] transition-all duration-200 cursor-pointer"
                  style={{ textDecoration: "none" }}
                >
                  <Icon size={18} className="text-[#025bff] mt-0.5 flex-shrink-0" />
                  ...
                  <ArrowRight size={14} className="text-[#d1d5db] group-hover:text-[#025bff] mt-0.5 flex-shrink-0 transition-colors duration-150" />
                </motion.a>
              );
            })}
          </div>
        ...
        {/* FAQ */}
        <section className="py-12 sm:py-14">
          <p className="text-[11px] font-bold text-[#9ca3af] tracking-[0.14em] mb-6">{c.faqLabel}</p>
        ...
        {/* Contact */}
        <section className="py-12 sm:py-14">
          <p className="text-[11px] font-bold text-[#9ca3af] tracking-[0.14em] mb-6">{c.contactLabel}</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <a
              href={`mailto:${c.email}`}
              className="group flex items-center gap-4 p-5 rounded-2xl border border-[#e5e7eb] hover:border-[#025bff]/40 hover:bg-[#fafbff] transition-all duration-200 cursor-pointer"
            >
              <Mail size={18} className="text-[#025bff] flex-shrink-0" />
              <div>
            ...
            <a
              ...
              className="group flex items-center gap-4 p-5 rounded-2xl border border-[#e5e7eb] hover:border-[#025bff]/40 hover:bg-[#fafbff] transition-all duration-200 cursor-pointer"
            >
              <Phone size={18} className="text-[#025bff] flex-shrink-0" />
              <div>
